...
import pn.eu.karinas.androidmvcsimpleexample.controller.LoginController.LoginControllerListener;
...
public class LoginActivity extends Activity implements LoginControllerListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((LoginView) this.findViewById(R.id.login)).setListeners2(loginController);		
	}
